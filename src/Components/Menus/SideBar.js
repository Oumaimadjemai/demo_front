...
export default function Sidebar({ onAction, selectedId }) {
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            id: "depense-list",
            text: "قائمة المصاريف",
            icon: <MoneyOffIcon sx={{ ...iconStyle }} />,
          },
          {
            id: "transfert",
            text: "التحويلات",
        ...
        children: [
          {
            id: "statistics",
            text: "إحصائيات",
            icon: <StackedLineChartIcon sx={{ ...iconStyle }} />,
          },
          {
            id: "rapport-vente",
            text: "تقرير المبيعات",
...
const isAllowed = (id) => {
  ...
  return features.includes(id); // User sees only their features
};
